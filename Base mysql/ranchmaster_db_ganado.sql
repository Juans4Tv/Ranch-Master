...
CREATE TABLE `ganado` (
  `id_ganado` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ganado_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
...
INSERT INTO `ganado` VALUES (9,'normando',2,78.00,'saludable',1),(10,'cebu',3,78.00,'enfermo',1);
